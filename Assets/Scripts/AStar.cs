...
public class AStar : MonoBehaviour {
    ...
    // declaring our open and closed lists, which will contain visited and nonvisited node
    public static PriorityClass closedList;
    public static PriorityClass openList;
    ...
    {
        openList = new PriorityClass();
        openList.Push(start);
        start.gCost = 0.0f; 
        start.hCost = EstimateHeuristicCost(start, goal);

        closedList = new PriorityClass();
        Node node = null;
